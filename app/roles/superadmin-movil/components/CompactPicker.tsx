        ...
        <>
            <TouchableOpacity
                ...
                style={[styles.pickerContainer, {
                    ...
                    backgroundColor: theme.cardBg || theme.inputBg,
                    height: 50 // Professional height
                }]}
            >
                <Text style={{ color: selectedValue ? theme.text : (theme.textMuted || theme.textSecondary), fontSize: 13, fontWeight: '500', flex: 1 }} numberOfLines={1}>
                    {selectedLabel}
                </Text>
                    ...
                    <View style={{ backgroundColor: theme.cardBg, borderTopLeftRadius: 25, borderTopRightRadius: 25, paddingBottom: Platform.OS === 'ios' ? 40 : 20, maxHeight: '80%' }}>
                        ...
                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', padding: 20, borderBottomWidth: 1, borderBottomColor: theme.border }}>
                            <TouchableOpacity onPress={() => setShowModal(false)}>
                                <Text style={{ color: theme.textMuted || theme.textSecondary, fontSize: 16, fontWeight: '600' }}>Cancelar</Text>
                            </TouchableOpacity>
